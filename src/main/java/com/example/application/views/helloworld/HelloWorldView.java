...
public class HelloWorldView extends VerticalLayout {
    ...
    public HelloWorldView() {
        ...
        kolTabs.setTabs("[{\"_label\":\"Koordinatenpaar/Koordinatenliste\",\"_href\":\"startseite\",\"_active\":true, \"_icon\":\"\"},{\"_label\":\"ESRI SHAPE-DATEIEN\",\"_href\":\"2-menuepunkt\", \"_icon\":\"\"},{\"_label\":\"CSV-Dateien\",\"_href\":\"startseite\", \"_icon\":\"\"}]");
        add(kolTabs);

        var koordSystemIn = new KolSelect();
        koordSystemIn.setList("[{'label':'Gauß-Krüger Koordinaten','value':'GKK'},{'label':'Geographische Koordinaten','value':'GK'}]");
